 ...
 *
 *  TEST TITLE           : Socket system calls regression - UNIX DATAGRAM bind()
 *
 ...
 *
 *  INPUT SPECIFICATION  : Usage: unix_bind_d [-f file]
 *			   file is the file that the program will be
 *			   binding to.  The default is unixd.bind.
 *
...
char *TCID= "unix_bind_d";	/* Test case identifier */
...
main(int argc, char *argv[])
{
  ...
  char *file="unixd.bind";/* the default file name for sun_path */
  extern int optind;
  extern char *optarg;
