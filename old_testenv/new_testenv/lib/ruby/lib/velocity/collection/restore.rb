class Collection
  def self.restore_saved_collection(name, source_directory)
    ...
    if TESTENV.windows
      ...
      gronk.execute('net use \\\\testbed5.test.vivisimo.com\testfiles ' +
                    '/user:testbed5.test.vivisimo.com\root mustang5', 'xml')
      # Make our Linux paths into Windows paths.
      remote_source_directory = '\\\\testbed5.test.vivisimo.com\testfiles\\' +
