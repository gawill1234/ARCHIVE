...
@XmlRootElement(name = "AnnotationGlobalSet")
public class AnnotationGlobalSet {
    ...
    @XmlElement(required = true)
    protected AnnotationGlobalSet.Content content;
     ...
     * @return
     *     possible object is
     *     {@link AnnotationGlobalSet.Content }
     *     
     */
    public AnnotationGlobalSet.Content getContent() {
        return content;
    }
     ...
     *     
     */
    public void setContent(AnnotationGlobalSet.Content value) {
        this.content = value;
    }
