...
@XmlRootElement(name = "AnnotationUserSet")
public class AnnotationUserSet {
    ...
    @XmlElement(required = true)
    protected AnnotationUserSet.Content content;
     ...
     * @return
     *     possible object is
     *     {@link AnnotationUserSet.Content }
     *     
     */
    public AnnotationUserSet.Content getContent() {
        return content;
    }
     ...
     *     
     */
    public void setContent(AnnotationUserSet.Content value) {
        this.content = value;
    }
