...
@XmlRootElement(name = "AnnotationAdd")
public class AnnotationAdd {
    ...
    @XmlElement(required = true)
    protected AnnotationAdd.Content content;
     ...
     * @return
     *     possible object is
     *     {@link AnnotationAdd.Content }
     *     
     */
    public AnnotationAdd.Content getContent() {
        return content;
    }
     ...
     *     
     */
    public void setContent(AnnotationAdd.Content value) {
        this.content = value;
    }
