 ...
 *       &lt;sequence>
 *         &lt;element ref="{urn:/velocity/objects}collection-service-rebase-files"/>
 *       &lt;/sequence>
...
@XmlType(name = "", propOrder = {
    "collectionServiceRebaseFiles"
})
@XmlRootElement(name = "collection-service-get-rebase-files")
public class CollectionServiceGetRebaseFiles {

    @XmlElement(name = "collection-service-rebase-files", required = true)
    protected CollectionServiceRebaseFiles collectionServiceRebaseFiles;
    @XmlAttribute
    ...
    /**
     * Gets the value of the collectionServiceRebaseFiles property.
     * 
     * @return
     *     possible object is
     *     {@link CollectionServiceRebaseFiles }
     *     
     */
    public CollectionServiceRebaseFiles getCollectionServiceRebaseFiles() {
        return collectionServiceRebaseFiles;
    }

    /**
     * Sets the value of the collectionServiceRebaseFiles property.
     * 
     * @param value
     *     allowed object is
     *     {@link CollectionServiceRebaseFiles }
     *     
     */
    public void setCollectionServiceRebaseFiles(CollectionServiceRebaseFiles value) {
        this.collectionServiceRebaseFiles = value;
    }
