...
class CONNECTOR(object):
   ...
   def __init__(self, connector_name=None, connector_version=None):
      ...
      self.connurl['lotus-notes'] = ["https://code.vivisimo.com/maven/content/repositories/releases/com/vivisimo/connector/lotus/__VREPLACE__/lotus-__VREPLACE__-TEST-distrib-DO_NOT_SHIP.zip", "lotus-__VREPLACE__.zip"]

      self.connversion['ucm'] = "2.0.2"
      self.connfunc['ucm'] = ["vse-crawler-seed-universal-ucm",
                              "universal-ucm-rights",
                              "universal-ucm-groups"]
      self.connurl['ucm'] = ["https://code.vivisimo.com/maven/content/repositories/releases/com/vivisimo/connector/universal-ucm/__VREPLACE__/universal-ucm-__VREPLACE__-TEST-distrib-DO_NOT_SHIP.zip", "universal-ucm-__VREPLACE__.zip"]
      ...
      self.connurl['sharepoint'] = ["https://code.vivisimo.com/maven/content/repositories/releases/com/vivisimo/connector/sharepoint/__VREPLACE__/sharepoint-__VREPLACE__-TEST-distrib-DO_NOT_SHIP.zip", "sharepoint-__VREPLACE__.zip"]
      ...
      self.connurl['io-sharepoint'] = ["https://code.vivisimo.com/maven/content/repositories/releases/com/vivisimo/connector/io-sharepoint/__VREPLACE__/io-sharepoint-__VREPLACE__-TEST-distrib-DO_NOT_SHIP.zip", "io-sharepoint-__VREPLACE__.zip"]
      ...
      self.connurl['confluence'] = ["https://code.vivisimo.com/maven/content/repositories/releases/com/vivisimo/connector/confluence/__VREPLACE__/confluence-__VREPLACE__-TEST-distrib-DO_NOT_SHIP.zip", "confluence-__VREPLACE__.zip"]
      ...
      self.connurl['livelink'] = ["https://code.vivisimo.com/maven/content/repositories/releases/com/vivisimo/connector/universal-livelink/__VREPLACE__/universal-livelink-__VREPLACE__-TEST-distrib-DO_NOT_SHIP.zip", "livelink-__VREPLACE__.zip"]
      ...
      self.connurl['filenetp8'] = ["https://code.vivisimo.com/maven/content/repositories/releases/com/vivisimo/connector/universal-filenetp8/__VREPLACE__/universal-filenetp8-__VREPLACE__-TEST-distrib-DO_NOT_SHIP.zip", "filenetp8-__VREPLACE__.zip"]
      ...
      self.connurl['samba'] = ["https://code.vivisimo.com/maven/content/repositories/releases/com/vivisimo/connector/samba/__VREPLACE__/samba-__VREPLACE__-TEST-distrib-DO_NOT_SHIP.zip", "samba-__VREPLACE__.zip"]
      ...
      self.connurl['database'] = ["https://code.vivisimo.com/maven/content/repositories/releases/com/vivisimo/connector/database/__VREPLACE__/database-__VREPLACE__-TEST-distrib-DO_NOT_SHIP.zip", "database-__VREPLACE__.zip"]
      ...
      self.connurl['documentum'] = ["https://code.vivisimo.com/maven/content/repositories/releases/com/vivisimo/connector/documentum/__VREPLACE__/documentum-__VREPLACE__-TEST-distrib-DO_NOT_SHIP.zip", "documentum-__VREPLACE__.zip"]
      ...
      self.connurl['siebel'] = ["https://code.vivisimo.com/maven/content/repositories/releases/com/vivisimo/connector/siebel/__VREPLACE__/siebel-__VREPLACE__-TEST-distrib-DO_NOT_SHIP.zip", "siebel-__VREPLACE__.zip"]
      ...
      self.connurl['eroom'] = ["https://code.vivisimo.com/maven/content/repositories/releases/com/vivisimo/connector/eroom/__VREPLACE__/eroom-__VREPLACE__-TEST-distrib-DO_NOT_SHIP.zip", "eroom-__VREPLACE__.zip"]
