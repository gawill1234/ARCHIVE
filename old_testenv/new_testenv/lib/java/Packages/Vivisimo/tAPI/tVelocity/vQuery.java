...
public class vQuery
{
    ...
    public void commonInit(String url, String collectionName) throws java.lang.Exception
    {
        ...
        Integer myport = Integer.valueOf(this.vQueryEnv.getVivPort());

        try {
           this.scServices = new vServices(url, this.collectionName);
           this.scServices.setSearchServicePort(myport);
           this.scServices.searchServiceSet();
        } catch (java.lang.Exception jle) {
           System.out.println("Query Port not set to:  " + myport);
           System.out.println("But we will try anyway.");
