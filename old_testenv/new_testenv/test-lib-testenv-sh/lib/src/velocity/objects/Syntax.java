 ...
 *         &lt;element ref="{urn:/velocity/objects}load-syntax"/>
 *       &lt;/choice>
...
@XmlType(name = "", propOrder = {
    "fieldOrOperatorOrLoadSyntax"
})
@XmlRootElement(name = "syntax")
public class Syntax {

    @XmlElements({
        @XmlElement(name = "load-syntax", type = LoadSyntax.class),
        @XmlElement(name = "field", type = Field.class),
        @XmlElement(name = "operator", type = Operator.class)
    })
    protected List<Object> fieldOrOperatorOrLoadSyntax;
    @XmlAttribute
    ...
    /**
     * Gets the value of the fieldOrOperatorOrLoadSyntax property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fieldOrOperatorOrLoadSyntax property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFieldOrOperatorOrLoadSyntax().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getFieldOrOperatorOrLoadSyntax() {
        if (fieldOrOperatorOrLoadSyntax == null) {
            fieldOrOperatorOrLoadSyntax = new ArrayList<Object>();
        }
        return this.fieldOrOperatorOrLoadSyntax;
    }
