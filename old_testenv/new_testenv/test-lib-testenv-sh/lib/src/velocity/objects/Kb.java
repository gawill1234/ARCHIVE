 ...
 *         &lt;group ref="{urn:/velocity/objects}kb"/>
 *         &lt;element ref="{urn:/velocity/objects}load-kb"/>
 *       &lt;/choice>
...
@XmlType(name = "", propOrder = {
    "stopwordOrStemOrRedisplay"
})
@XmlRootElement(name = "kb")
public class Kb {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "load-kb", type = LoadKb.class),
        @XmlElement(name = "evoke", type = Evoke.class),
        @XmlElement(name = "redisplay", type = Redisplay.class)
    })
    protected List<Object> stopwordOrStemOrRedisplay;
    @XmlAttribute
    ...
    /**
     * Gets the value of the stopwordOrStemOrRedisplay property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the stopwordOrStemOrRedisplay property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStopwordOrStemOrRedisplay().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getStopwordOrStemOrRedisplay() {
        if (stopwordOrStemOrRedisplay == null) {
            stopwordOrStemOrRedisplay = new ArrayList<Object>();
        }
        return this.stopwordOrStemOrRedisplay;
    }
