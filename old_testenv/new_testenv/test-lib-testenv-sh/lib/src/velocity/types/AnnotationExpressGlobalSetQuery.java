...
@XmlRootElement(name = "AnnotationExpressGlobalSetQuery")
public class AnnotationExpressGlobalSetQuery {
    ...
    @XmlElement(required = true)
    protected AnnotationExpressGlobalSetQuery.Content content;
    @XmlElement(required = true)
    protected AnnotationExpressGlobalSetQuery.Query query;
     ...
     * @return
     *     possible object is
     *     {@link AnnotationExpressGlobalSetQuery.Content }
     *     
     */
    public AnnotationExpressGlobalSetQuery.Content getContent() {
        return content;
    }
     ...
     *     
     */
    public void setContent(AnnotationExpressGlobalSetQuery.Content value) {
        this.content = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link AnnotationExpressGlobalSetQuery.Query }
     *     
     */
    public AnnotationExpressGlobalSetQuery.Query getQuery() {
        return query;
    }
     ...
     *     
     */
    public void setQuery(AnnotationExpressGlobalSetQuery.Query value) {
        this.query = value;
    }
