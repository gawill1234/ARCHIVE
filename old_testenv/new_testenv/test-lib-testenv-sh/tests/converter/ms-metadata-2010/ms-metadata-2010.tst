...
if __name__ == "__main__":
   ...
   #explist = ['smb://' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/test_data/metadata_test/exceltest.xls']
   ...
   explist = ['smb://' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/test_data/metadata_2010/bugs-2010-07-06.xlsx',
              'smb://' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/test_data/metadata_2010/agenda.docx']
   ...
   explist = ['smb://' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/test_data/metadata_2010/bugs-2010-07-06.xlsx',
              'smb://' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/test_data/metadata_2010/Database1.accdb',
              'smb://' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/test_data/metadata_2010/OneNote_basics.one',
              'smb://' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/test_data/metadata_2010/Personal.onepkg',
              'smb://' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/test_data/metadata_2010/Publication1.pub',
              'smb://' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/test_data/metadata_2010/QA%20Initiatives.pptx',
              'smb://' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/test_data/metadata_2010/agenda.docx']
   ...
   explist = ['smb://' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/test_data/metadata_2010/QA%20Initiatives.pptx',
              'smb://' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/test_data/document/DOC/TE1%2520Revised%2520%282%29%2520Amend%25200013%2520Final.doc']
