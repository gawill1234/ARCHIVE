...
if __name__ == "__main__":
   ...
   zing = ['file://///' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/samba_test_data/samba-1/doc/fedpaper.txt', 'file://///' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/samba_test_data/samba-1/doc/arizona.txt', 'file://///' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/samba_test_data/samba-1/doc/federa00.htm', 'file://///' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/samba_test_data/samba-1/doc/constitution.pdf']
   zing2 = ['file://///' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/samba_test_data/samba-1/doc/fedpaper.txt', 'file://///' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/samba_test_data/samba-1/doc/constitution.txt', 'file://///' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/testfiles/samba_test_data/samba-1/doc/federa00.htm', 'file://///' + os.getenv( 'VIV_SAMBA_LINUX_SERVER' ) + '/' + os.getenv( 'VIV_SAMBA_LINUX_SHARE' ) + '/samba_test_data/samba-1/doc/constitution.pdf']

   collection_name = "aqs-2"
   tname = "api-query-search-2"
