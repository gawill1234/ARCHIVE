...
<vce version="4.0">
<application name="vivStrToUpper" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
    <parse encode="encode" filename="file://{viv:value-of('install_dir', 'option')}/data/vivStrToUpper.xml">
