...
if __name__ == "__main__":
   ...
   collection_name = "asceqd-1"
   tname = 'api-sc-enqueue-deletes-1'
   ...
   del_url4 = '<crawl-delete url="http://testbed4.test.vivisimo.com/pages/would_again.htm" /><crawl-delete url="http://testbed4.test.vivisimo.com/docs/Current_Resume.htm" />'
   ...
   yy.api_sc_enqueue_deletes(xx=xx, collection=collection_name, url=del_url)
   xx.wait_for_idle(collection=collection_name)
   ...
   print tname, ":  refresh the crawl"
   yy.api_sc_enqueue_deletes(xx=xx, collection=collection_name, url=del_url2)
   yy.api_sc_enqueue_deletes(xx=xx, collection=collection_name, url=del_url3)
   xx.wait_for_idle(collection=collection_name)
   ...
   print tname, ":  refresh the crawl"
   yy.api_sc_enqueue_deletes(xx=xx, collection=collection_name, url=del_url4)
   xx.wait_for_idle(collection=collection_name)
