...
if __name__ == "__main__":
   ...
   thelper.set_linux_samba_collection_access_data("aqs-8a.xml.base",
             "aqs-8a.xml")
   thelper.set_linux_samba_collection_access_data("aqs-8b.xml.base",
             "aqs-8b.xml")
   ...
   thelper.set_linux_samba_collection_access_data(
             "compare_data/defaults2.wazzat.base",
             "compare_data/defaults2.wazzat")
   ...
   thelper.set_linux_samba_collection_access_data(
             "compare_data/defaults3.wazzat.base",
             "compare_data/defaults3.wazzat")
   ...
   if ( fail == 0 ):
      ...
      os.remove("aqs-8a.xml")
      os.remove("aqs-8b.xml")
      os.remove("compare_data/defaults2.wazzat")
      os.remove("compare_data/defaults3.wazzat")
