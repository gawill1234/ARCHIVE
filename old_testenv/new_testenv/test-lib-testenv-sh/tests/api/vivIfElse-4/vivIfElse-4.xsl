...
<vce version="4.0">
<application name="vivIfElse-4" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <br/><br/>
      <b>Description:</b>  Test of unequal integer comparison condition<br/><br/>
      ...
      <xsl:variable name="myint1" select="100" as="xs:integer"/>
      <xsl:variable name="myint2" select="200" as="xs:integer"/>
