...
<vce version="4.0">
<application name="vivStrToLower-3" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <br/><br/>
      <b>Description:</b>  vivStrToLower-3 -- non-alphanum string variable remains unchanged<br/><br/>
      ...
      <b>Expected Result:</b>  !@# &gt;&lt;*$%^&amp;()_+=-[]{};:,./?\|<br/><br/>
      <xsl:variable name="string1" select="string('!@# &gt;&lt;*$%^&amp;()_+=-[]{};:,./?\|')"/>
      <xsl:variable name="expected" select="string('!@# &gt;&lt;*$%^&amp;()_+=-[]{};:,./?\|')"/>
   ...
   <xsl:template name="PassFail">
      ...
      <xsl:choose>
         <xsl:when test="$result = $expect">
            <br/>
            <font color="green">
            <b>vivStrToLower-3:  TEST PASSED</b>
            </font>
            <br/>
         </xsl:when>
         <xsl:otherwise>
            <br/>
            <font color="red">
            <b>vivStrToLower-3:  TEST FAILED</b>
            </font>
            <br/>
         </xsl:otherwise>
      </xsl:choose>
