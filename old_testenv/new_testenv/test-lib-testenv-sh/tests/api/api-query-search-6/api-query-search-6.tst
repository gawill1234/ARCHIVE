...
if __name__ == "__main__":
   ...
   thelper = test_helpers.TEST_HELPERS(yy, xx, None, "api-query-search-6")
   thelper.set_linux_samba_collection_access_data("aqs-6a.xml.base", "aqs-6a.xml")
   thelper.set_linux_samba_collection_access_data("aqs-6b.xml.base", "aqs-6b.xml")
   ...
   if ( cs_pass == 0 ):
      ...
      os.remove("aqs-6a.xml")
      os.remove("aqs-6b.xml")
