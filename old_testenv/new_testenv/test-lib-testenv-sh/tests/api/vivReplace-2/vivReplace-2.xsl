...
<vce version="4.0">
<application name="vivReplace-2" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <br/><br/>
      <b>Description:</b>  regex substring replacement<br/><br/>
      ...
      <b>Expected Result:</b>  The slow brown fox jumps over the lazy dog<br/><br/>
      ...
      <xsl:variable name="expected" select="string('The slow brown fox jumps over the lazy dog')"/>
