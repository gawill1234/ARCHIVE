...
<vce version="4.0">
<application name="vivIfElse-9" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <br/><br/>
      <b>Description:</b>  Test of equal function condition<br/><br/>
      <b>Function:</b>  viv:if-else(true() = true(),'TRUE', 'FALSE')<br/><br/>
      <b>Variable Values:</b>
      <ul>
      <li>
      <b>NONE</b>
      ...
      <xsl:variable name="resval" select="viv:if-else(true() = true(),'TRUE', 'FALSE')"/>
