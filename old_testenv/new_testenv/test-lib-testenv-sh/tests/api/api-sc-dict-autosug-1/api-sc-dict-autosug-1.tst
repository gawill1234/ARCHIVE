...
if __name__ == "__main__":
   ...
   pres = ['page', 'plank', 'popular', 'people', 'presidential', 'postcards',
           'photographs', 'plants', 'problems', 'phone', 'process',
           'president', 'previous', 'puts', 'plastic', 'pierre']
   ...
   ret = yy.check_list(zz, pres)
   if ( ret == 0 ):
      print tname, ":  collection based dictionary"
      print tname, ":  'p' query case passed"
   else:
   ...
   print tname, ":  Collection based dictionary"
   print tname, ":  example-metadata collection"
   print tname, ":  get phrase list for 'P'(upper case)"
