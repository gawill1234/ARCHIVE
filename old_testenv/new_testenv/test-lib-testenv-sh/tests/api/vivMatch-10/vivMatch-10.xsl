...
<vce version="4.0">
<application name="vivMatch-10" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <br/><br/>
      <b>Description:</b>  match of string in brackets, ignore case<br/><br/>
      <b>Function:</b>  viv:match($matchString,$regexStr, 'i')<br/><br/>
      <b>Variable Values:</b>
      <ul>
      <li>
      <b>matchString:</b>   ignore [brackets match test] ignore
      </li>
      <li>
      <b>regexStr:</b>   \[.*\]
      </li>
      </ul>
      <b>Expected Result:</b>  [brackets match test]<br/><br/>
      <xsl:variable name="matchString" select="string('ignore [brackets match test] ignore')"/>
      <xsl:variable name="regexStr" select="string('\[.*\]')"/>
      <xsl:variable name="expected" select="string('[brackets match test]')"/>
