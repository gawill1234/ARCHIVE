...
<vce version="4.0">
<application name="vivChoose-5" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <xsl:variable name="resval" select="viv:choose(true(),$condA,$condDefault)"/>
