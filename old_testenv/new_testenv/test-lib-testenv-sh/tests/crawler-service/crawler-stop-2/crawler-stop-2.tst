...
#   Global stuff
#
#   This test creates a collection and refreshes a crawl.
#   After the refresh is started, it periodically kills the
...
###
   ...
   VCOLLECTION="crawler-stop-2"
   DESCRIPTION="Refresh and query collection while stopping/resuming crawler"
