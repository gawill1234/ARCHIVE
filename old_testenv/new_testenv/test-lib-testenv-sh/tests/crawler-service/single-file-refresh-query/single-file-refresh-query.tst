...
if __name__ == "__main__":
   ...
   if ( xx.TENV.targetos == "windows" ):
      ...
      f = open( "sfrq-win.xml.base", 'r' )
      data = f.read()
      f.close()
      data = data.replace("VIV_SAMBA_LINUX_SERVER", os.getenv('VIV_SAMBA_LINUX_SERVER'))
      data = data.replace("VIV_SAMBA_LINUX_USER", os.getenv('VIV_SAMBA_LINUX_USER'))
      data = data.replace("VIV_SAMBA_LINUX_PASSWORD", os.getenv('VIV_SAMBA_LINUX_PASSWORD'))
      data = data.replace("VIV_SAMBA_LINUX_SHARE", os.getenv('VIV_SAMBA_LINUX_SHARE'))
      f = open( "sfrq-win.xml", 'w' )
      f.write( data )
      f.close()
