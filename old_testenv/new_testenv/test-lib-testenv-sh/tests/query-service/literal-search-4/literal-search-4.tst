...
if __name__ == "__main__":
   ...
   collection_name = "literal-search-4"
   tname = 'literal-search-4'
   ...
   cs_pass = cs_pass + yy.query_result_check(xx=xx, casenum=8,
                      clustercount=0, perpage=2, num=2, filename='emailpart',
                      testname=tname)
   ...
   explist = ['http://vivisimo.com?lp3',
              ...
              'http://vivisimo.com?lp8',
              'http://vivisimo.com?lp9',
              'http://vivisimo.com?lp10',
              'http://vivisimo.com?lp11',
              'http://vivisimo.com?lp12',
              'http://vivisimo.com?lp13',
              'http://vivisimo.com?lp14',
   ...
   cs_pass = cs_pass + yy.query_result_check(xx=xx, casenum=13,
                      clustercount=0, perpage=12, num=12, filename='lp3',
                      testname=tname)
   ...
   print tname, ":  #######################################"
   print tname, ":  CASE 16"
   print tname, ":     license plate, qtm=3333 wide char query"
   ...
   cs_pass = cs_pass + yy.query_result_check(xx=xx, casenum=16,
                      clustercount=0, perpage=12, num=12, filename='lp16',
                      testname=tname)
   ...
   cs_pass = cs_pass + yy.query_result_check(xx=xx, casenum=17,
                      clustercount=0, perpage=12, num=12, filename='lp17',
                      testname=tname)
