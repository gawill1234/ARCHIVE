...
if __name__ == "__main__":
   ...
   if ( sitetype == '2010' ):
      ...
      collection_name = "sp-continuous-upd-1-2010"
      ...
      collection_name = "sp-continuous-upd-1-2007"
   ...
   try:
      ...
      print tname, ":  Stop the original crawl so it can be updated"
      ...
      print tname, ":  Update collection to continuous update mode"
      shutil.copy(contname, workname)
      yy.api_repository_update(xmlfile=workname)
      yy.api_sc_update_config(collection=collection_name)
   
      print tname, ":  Resume the crawler using continuous update"
