...
def Do_Case_6(tname=None, xx=None, yy=None, collection=None, hard_result=80):

   liststoplace = ['law/US/26', 'law/F3/465', 
                   'law/F2/643', 'law/US/360', 'law/F3/27']
   expectedcnt = [7, 0, 0, 50, 2]
...
def Do_Case_7(tname=None, xx=None, yy=None, collection=None, hard_result=80):
...
if __name__ == "__main__":
   ...
   if ( sitetype == '2010' ):
      hreslist = [15, 124, 70, 72, 72, 80, 80]
   ...
   print tname, ":     Basic crawl and update using the new sharepoint connector"
   print tname, ":     with URL filters used to limit indexed data."
   total_results = 0
   ...
   try:
      ...
      print tname, ":  Flushing old data which is not applicable to the test ..."
      doc_updater.flush_all_data(tname, xx, yy, 0, **cmd_params)
      print tname, ":  ... Flush complete."
