...
#
#
def Watch_The_Threads(tname=None, xx=None, yy=None, collection=None, cwait=True):
...
if __name__ == "__main__":
   ...
   if ( sitetype == '2010' ):
      ...
      cmd_params['pw'] = pw = 'VolvoV70'
      cmd_params['domain'] = domain = 'sp07test'
      collection_name = "bug27738-oldconn"
      lock = simpleLock.simpleLock("tb19-2.36436")
   ...
   try:
      ...
      if ( collection_name == 'bug27738-oldconn' ):
      ...
      #
      if ( collection_name == 'bug27738-2010' ):
      ...
      for item in qlist:
         ...
         Watch_The_Threads(tname, xx, yy, collection_name, howlong)
