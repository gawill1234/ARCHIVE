...
if __name__ == "__main__":
   ...
   if ( sitetype == '2010' ):
      ...
      collection_name = "sp-manylists-1-2010"
      ...
      collection_name = "sp-manylists-1-2007"
      ...
      cmd_params['pw'] = pw = 'VolvoV70'
      cmd_params['domain'] = domain = 'sp07test'
      collection_name = "sp-manylists-1-oldconn"
      lock = simpleLock.simpleLock("tb19-2.36436")
   ...
   try:
      ...
      if ( collection_name == 'sp-manylists-1-oldconn' ):
      ...
      #
      if ( collection_name == 'sp-manylists-1-2010' ):
