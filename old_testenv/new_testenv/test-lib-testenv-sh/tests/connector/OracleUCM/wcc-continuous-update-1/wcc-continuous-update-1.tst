...
import run_bulk_loader, getopt, time
...
if __name__ == "__main__":
   ...
   if ( sitetype == 'WCC' ):
      ...
      collection_name = "wcc-continuous-1"
      glob_results = [1406, 48]
      ...
      collection_name = "ucm-continuous-1"
      glob_results = [1390, 34]
      lock = simpleLock.simpleLock("tb6-6.UCM")
   else:
      print "Unknown connector type: ", sitetype
