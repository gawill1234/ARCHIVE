...
###
   ...
   VCOLLECTION="content-size-3"
   DESCRIPTION="Content size of 10593027 (file size) with edge queries"
...
#
basic_query_test 3 $SHOST $VCOLLECTION "53967871"
if [ $results -eq 0 ]; then
   testpass=1
else
...
#
basic_query_test 4 $SHOST $VCOLLECTION 1245750260153694554008555
if [ $results -eq 0 ]; then
   testpass=1
else
