...
#   constitution.pdf is limited access to test\jet.  The whole share
#   is limited to test\jet and testbed2\fuzzy_lumpkin.
#
...
###
   ...
   VCOLLECTION="samba-restricted-5"
   DESCRIPTION="User restricted samba crawl and search of various doc types with legal local user"
