...
test_results = TestResults.new("Samba crawl test - Large Linux 64 bit samba crawl and search of various doc types using uppercase username")
...
uppercase_username = username.upcase
...
crawler_config = <<XML
  ...
  <call-function name="vse-crawler-seed-smb">
    ...
    <with name="username"><![CDATA[#{uppercase_username}]]></with>
