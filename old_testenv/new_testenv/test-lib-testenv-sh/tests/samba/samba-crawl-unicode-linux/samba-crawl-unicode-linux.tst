...
test_results = TestResults.new("Samba crawl - Files with unicode - Linux 64 bit")
...
crawler_config = <<XML
  ...
  <call-function name="vse-crawler-seed-smb">
    ...
    <with name="shares"><![CDATA[/#{ENV['VIV_SAMBA_LINUX_SHARE']}/samba_test_data/samba-3/doc]]></with>
