...
public class bug25367
{

    static String testName = "bug25367";
    ...
    public static void main(String[] args) {
       ...
       String collectionName = "bug25367";
       int passCount = 0;
       int ePassCount = 5;
       ...
       if (goodQuery(yy, "E3 AND S5 AND Additional WITHIN 3 WORDS", 1)) {
          passCount += 1;
       }

       if (goodQuery(yy, "E1 AND S5 AND Additional WITHIN 3 WORDS", 0)) {
          passCount += 1;
       }

       if (goodQuery(yy, "In this exercise", 0)) {
          passCount += 1;
       }

       if (goodQuery(yy, "Boosting", 1)) {
          passCount += 1;
       }
