...
###
   ...
   VCOLLECTION="samba-one-dotppt"
   DESCRIPTION="samba crawl of one power point file"
...
#
basic_query_test 1 $SHOST $VCOLLECTION boeing
basic_query_test 2 $SHOST $VCOLLECTION cnn
