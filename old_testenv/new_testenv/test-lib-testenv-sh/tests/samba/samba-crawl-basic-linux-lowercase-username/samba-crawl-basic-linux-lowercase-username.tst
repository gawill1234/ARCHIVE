...
test_results = TestResults.new("Samba crawl test - Basic Linux 64 bit samba crawl and search of various doc types using lowercase username")
...
crawler_config = <<XML
  ...
  <call-function name="vse-crawler-seed-smb">
    ...
    <with name="shares"><![CDATA[/#{ENV['VIV_SAMBA_LINUX_SHARE']}/samba_test_data/samba-4/doc]]></with>
    <with name="username"><![CDATA[#{lowercase_username}]]></with>
