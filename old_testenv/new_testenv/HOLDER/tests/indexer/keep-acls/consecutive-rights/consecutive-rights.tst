...
<crawl-urls>
  <crawl-url url="b" status="complete" synchronization="indexed">
    <crawl-data encoding="xml" content-type="application/vxml">
      <document>
        <content name="main" acl="acl1">data1</content>
        <content name="main2" acl="acl1">data2</content>
      </document>
    </crawl-data>
  </crawl-url>
</crawl-urls
...
results = TestResults.new('Ensure multiple consecutive contents with the same rights only save the rights once')
