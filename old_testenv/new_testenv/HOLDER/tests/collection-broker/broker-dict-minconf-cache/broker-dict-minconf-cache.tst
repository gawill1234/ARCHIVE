...
sim.set('/EVaultSim/server/n-users', 100)         # total cols
sim.set('/EVaultSim/server/max-active-users', 10) # parallel cols
sim.set('/EVaultSim/n-enqueuers', 10)             # total threads
sim.set('/EVaultSim/server/max-documents', 1000)  # docs per col
sim.set('/EVaultSim/batch-size', 1)               # docs per enqueue
sim.set('/EVaultSim/content-size', 1000000)       # words per doc
# (no updates & deletes)
sim.set('/EVaultSim/vse-config/vse-index/vse-index-option[@name="cache-mb"]', 1000) # MB Cache
