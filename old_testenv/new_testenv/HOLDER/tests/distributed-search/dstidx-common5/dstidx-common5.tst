...
def create_server_file(collection_list, other_server_collection, lightcrawl,
   ...
   root_dir = os.getenv('TEST_ROOT', '../dstidx-common5')
   ...
   if ( lightcrawl ):
      filename = root_dir + '/tests/distributed-search/dstidx-common5/' + filename
   else:
      filename = root_dir + '/tests/distributed-search/dstidx-common5/' + filename
...
def create_client_file(my_server, my_server2, current_client,
   ...
   if ( lightcrawl ):
      filename = root_dir + '/tests/distributed-search/dstidx-common5/purebaselgtxml'
   else:
      filename = root_dir + '/tests/distributed-search/dstidx-common5/purebasexml'
...
if __name__ == "__main__":
   ...
   root_dir = os.getenv('TEST_ROOT', '../dstidx-common5')
   test_root = root_dir + '/tests/distributed-search/dstidx-common5/'
