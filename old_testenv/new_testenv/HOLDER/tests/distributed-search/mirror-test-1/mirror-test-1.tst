...
#   serving collection. The crawler should recover and complete
...
#   should return the known correct result
#
###
   
   source $TEST_ROOT/lib/global_setting.sh

   VTESTNAME="mirror-test-1"
   VCOLLECTION_SERVER="mirror-test-1-server"
   VCOLLECTION_CLIENT="mirror-test-1-client"
   DESCRIPTION="Crawl and query a mirrored collection while killing/resuming the serving crawler"
...
while [ $x -eq 3 ]; do
   ...
   echo "Kill server crawler and then wait $sleepval seconds"
