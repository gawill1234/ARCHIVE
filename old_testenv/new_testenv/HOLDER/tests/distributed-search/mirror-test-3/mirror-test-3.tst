...
#   client and server collections. The crawler should recover and complete
...
###
   ...
   VTESTNAME="mirror-test-3"
   VCOLLECTION_SERVER="mirror-test-3-server"
   VCOLLECTION_CLIENT="mirror-test-3-client"
   DESCRIPTION="Crawl and query a distributed collection while killing/resuming the client and server crawlers"
