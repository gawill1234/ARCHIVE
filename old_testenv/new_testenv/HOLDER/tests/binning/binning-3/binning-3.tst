...
###
   ...
   VCOLLECTION="binning-3"
   DESCRIPTION="simple oracle crawl and search with multiple, nested binning sets"
...
full_bin_test 5 $SHOST $VCOLLECTION ship:Battleship
full_bin_test 6 $SHOST $VCOLLECTION ship:Cruiser
full_bin_test 7 $SHOST $VCOLLECTION ship:Battlecruiser:nations:USA
full_bin_test 8 $SHOST $VCOLLECTION ship:Frigate:nations:UK
full_bin_test 9 $SHOST $VCOLLECTION algn:allied
