...
search.activate_facet("other-selections-id", "USA")
binning_result = search.activate_facet_and_save("other-selections-id", "PA")
...
binning_result.within("other-selections-id") do |facet_values|
  ...
  facet_values.within("USA") do |facet_values|
    results.add_set_equals(%w{PA NY}, facet_values.labels,
...
binning_result.within("regular-id") do |facet_values|
  ...
  facet_values.within("USA") do |facet_values|
    results.add_set_equals(%w{PA}, facet_values.labels,
