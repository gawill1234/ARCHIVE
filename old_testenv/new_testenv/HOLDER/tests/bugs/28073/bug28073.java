...
public class bug28073
{

    static String testName = "bug28073";
    ...
    public static void main(String[] args) {
       ...
       String collectionName = "bug28073";
       int passCount = 0;
       int ePassCount = 9;
       ...
       if (goodQuery(yy, "Hamilton", 757)) {
          passCount += 1;
       }

       if (goodQuery(yy, "Hamilton AND Madison", 443)) {
          passCount += 1;
       }

       if (goodQuery(yy, "Hamilton OR Madison", 995)) {
          passCount += 1;
       }

       if (goodQuery(yy, "Hamilton + Madison", 443)) {
          passCount += 1;
       }

       if (goodQuery(yy, "Linux", 826)) {
          passCount += 1;
       }
       ...
       if (goodQuery(yy, "We AND the AND people", 1238)) {
          passCount += 1;
       }
