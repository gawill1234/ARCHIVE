...
if __name__ == "__main__":
   ...
   collection_name = "xmlType_test_9"
   tname = "xmlType-9"
   ...
   print tname, ":     XMLType as table column"
   print tname, ":     Using custom sql seed with XMLType functions"
   total_results = 0
   ...
   try:
      ...
      cstime = time.time()
      current_results = Do_Case_1(tname=tname, xx=xx, yy=yy, qry="mysql",
                                  collection=collection_name, 
