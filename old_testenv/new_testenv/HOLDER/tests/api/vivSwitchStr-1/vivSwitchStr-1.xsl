...
<vce version="4.0">
<application name="vivSwitchStr-1" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <b>Function:</b>  viv:switch-string('MATCHED',$other1,'wrong',$matchIt,$matchIt,$other2,'wrong','No-match','wrong',$condDefault)<br/><br/>
      <b>Variable Values:</b>
      <ul>
      <li>
      <b>other1:</b>   OTHER1
      ...
      <b>Expected Result:</b>  MATCHED<br/><br/>
      ...
      <xsl:variable name="expected" select="string('MATCHED')"/>

      <xsl:variable name="resval" select="viv:switch-string('MATCHED',$other1,'wrong',$matchIt,$matchIt,$other2,'wrong','No-match','wrong',$condDefault)"/>
