...
<vce version="4.0">
<application name="vivChoose-1" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <br/><br/>
      <b>Description:</b>  vivChoose02 -- vivChoose(): Second choice is true<br/><br/>
      <b>Function:</b>  viv:choose(false(),$condA,true(),$condB,$condDefault)<br/><br/>
      <b>Variable Values:</b>
      <ul>
      <li>
      ...
      <xsl:variable name="expected" select="string('ConditionB')"/>
      <xsl:variable name="resval" select="viv:choose(false(),$condA,true(),$condB,$condDefault)"/>
