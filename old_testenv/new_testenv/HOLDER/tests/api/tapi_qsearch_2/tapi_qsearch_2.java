...
public class tapi_qsearch_2
{

    private static Logger log = Logger.getLogger(tapi_qsearch_2.class.getName());
                              ...
                              boolean forceDelete) throws java.lang.Exception
    {
        ...
        try {
            ...
            System.out.println("==================================");
            System.out.println("Query:  Start is 10, Num is 5");
            m.setStart(10);
            m.setNum(5);
            m.runQueries(myquery, "querywork/urls-4.txt");
            fileLines = m.countLinesInFile("querywork/urls-4.txt");
            System.out.println("Expecting 5, Got " + fileLines);
            if (fileLines != 5) {
               passfail = 1;
            ...
            System.out.println("==================================");
            System.out.println("Query:  Start is 10, Num is 5, NumPerSource is 5");
            m.setNumPerSource(5);
            m.runQueries(myquery, "querywork/urls-5.txt");
            fileLines = m.countLinesInFile("querywork/urls-5.txt");
            System.out.println("Expecting 5, Got " + fileLines);
            if (fileLines != 5) {
               passfail = 1;
               log.severe("     SECTION FAILED");
    ...
    public static void main(String[] args) throws java.lang.Exception
    {
        ...
        if (passfail == 0) {
           System.out.println("tapi_qsearch_2(java):  Test Passed");
           System.exit(0);
        }

        System.out.println("tapi_qsearch_2(java):  Test Failed");
        System.exit(1);
    }
}
