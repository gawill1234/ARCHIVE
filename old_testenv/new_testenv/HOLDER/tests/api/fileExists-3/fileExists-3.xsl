<application name="fileExists-3" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <br/><br/>
      <b>Description:</b>  Check existence of existing directory<br/><br/>
      <b>Function:</b>  file:exists($file1)<br/><br/>
      <b>Variable Values:</b>
      <ul>
      <li>
      ...
      <xsl:variable name="resval" select="file:exists($file1)"/>
