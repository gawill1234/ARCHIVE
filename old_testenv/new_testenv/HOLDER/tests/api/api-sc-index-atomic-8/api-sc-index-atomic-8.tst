...
def do_crawl_delete(crawl_urls=None, filename=None,
   ...
   if ( use_origin ):
      originator = "api-sc-index-atomic-8"
   else:
      originator = None
...
def do_crawl_url(idx_atomic=None, filename=None,
...
def enqueue_it(crawl_urls=None):
   ...
   global dumpofd, yy, collection_name2, dumpresp, did_enqueue
...
def do_crawl_urls(idx_atomic=None, 
                  filename=None,
                  use_origin=False, use_id=False, 
...
def do_filelist(idx_atomic, filelist=None,
                  use_origin=False, use_id=False, use_url=False,
                  use_vsekey=False):

   global dopartial, enqueueid, did_enqueue, xx, collection_name2

   did_enqueue = dopartial = 0
   ...
   for item in filelist:
      ...
      idx_atomic = do_crawl_urls(idx_atomic, 
                                 item,
                                 use_origin, use_id,
                                 use_url, use_vsekey,
                                 use_partial="yes")
...
def do_enqueues(dir, use_origin=False, use_id=False, 
   ...
   for path, dirs, files in os.walk(dir):
      ...
      idx_atomic = do_filelist(idx_atomic,
                               filelist,
                               use_origin, use_id,
                               use_url, use_vsekey)
...
if __name__ == "__main__":
   ...
   global tname, dumpofd, yy, collection_name2, dumpresp, xx
   ...
   collection_name2 = "scia-8"
   tname = "api-sc-index-atomic-8"

   ##############################################################
   print tname, ":  ##################"
   print tname, ":  INITIALIZE"
   print tname, ":  index-atomic test 8"
   ...
   print tname, ":     All index-atomic nodes are standalone nodes."
