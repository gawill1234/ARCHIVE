...
<vce version="4.0">
<application name="vivIfElse-5" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <br/><br/>
      <b>Description:</b>  Test of equal double comparison condition<br/><br/>
      ...
      <xsl:variable name="myint2" select="100.0" as="xs:double"/>
