...
<vce version="4.0">
<application name="vivMatch-2" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <br/><br/>
      <b>Description:</b>  variable string matches same variable string<br/><br/>
      <b>Function:</b>  viv:match($string1,$string1)<br/><br/>
      <b>Variable Values:</b>
      <ul>
      <li>
      <b>string1:</b>   abc
      ...
      <xsl:variable name="resval" select="viv:match($string1,$string1)"/>
