...
#   index-atomic node.   index-atomic is itself placed within a
#   crawl-urls node.
#
...
def do_crawl_delete(idx_atomic=None, filelist=None, synchro=None,
   ...
   if ( use_origin ):
      originator = "api-sc-index-atomic-3"
   else:
      originator = None
...
if __name__ == "__main__":
   ...
   collection_name2 = "scia-3"
   cfile = collection_name2 + '.xml'
   tname = "api-sc-index-atomic-3"

   ##############################################################
   print tname, ":  ##################"
   print tname, ":  INITIALIZE"
   print tname, ":  index-atomic test 3"
