...
<vce version="4.0">
<application name="vivIfElse-8" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <b>Function:</b>  viv:if-else(false() = true(),'TRUE', 'FALSE')<br/><br/>
      <b>Variable Values:</b>
      <ul>
      <li>
      <b>NONE</b>
      ...
      <xsl:variable name="resval" select="viv:if-else(false() = true(),'TRUE', 'FALSE')"/>
