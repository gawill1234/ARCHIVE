...
<vce version="4.0">
<application name="vivChoose-2" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <br/><br/>
      <b>Description:</b>  vivChoose02 -- vivChoose(): Default choice is true<br/><br/>
      <b>Function:</b>  viv:choose(false(),$condA,false(),$condB,$condDefault)<br/><br/>
      <b>Variable Values:</b>
      <ul>
      <li>
      ...
      <xsl:variable name="resval" select="viv:choose(false(),$condA,false(),$condB,$condDefault)"/>
