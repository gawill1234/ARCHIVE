...
<vce version="4.0">
<application name="vivSwitchStr-2" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <b>Function:</b>  viv:witch-string('NO-MATCHES',$other1,'wrong',$matchIt,$matchIt,$other2,'wrong','No-match','wrong',$condDefault)<br/><br/>
      <b>Variable Values:</b>
      <ul>
      <li>
      <b>other1:</b>   OTHER1
