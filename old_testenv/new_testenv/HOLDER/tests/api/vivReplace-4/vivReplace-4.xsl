...
<vce version="4.0">
<application name="vivReplace-4" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <br/><br/>
      <b>Description:</b>  regex substring replacement, indeterminate start<br/><br/>
      ...
      <xsl:variable name="string2" select="string('.[uv][hi].*n')"/>
