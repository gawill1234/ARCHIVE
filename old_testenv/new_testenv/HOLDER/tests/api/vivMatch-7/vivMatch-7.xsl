...
<vce version="4.0">
<application name="vivMatch-7" modified-by="gary_testing" max-elt-id="1"
  modified="1209666370"
>
  ...
  <print>
   ...
   <xsl:template match="/">
      ...
      <br/><br/>
      <b>Description:</b>  variable substring match of regex string, ignore case<br/><br/>
