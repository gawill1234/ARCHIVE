...
#   crawler.  The crawler should recover and complete
#   normally.  It kills the crawler 25 times, then
...
#
#   This variant uses the fast-resume=PARANOID crawler-option.
#
###
   
   source $TEST_ROOT/lib/global_setting.sh

   VCOLLECTION="crawler-die-3"
