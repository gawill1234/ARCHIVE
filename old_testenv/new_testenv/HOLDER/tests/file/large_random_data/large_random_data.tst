...
###
   ...
   VCOLLECTION="large_random_data"
   DESCRIPTION="samba crawl of large, changing data set"
...
#   from the index data.
#
REPLACEIT='smb://testbed5.test.vivisimo.com/testfiles'
REPLACEWITH='/testenv'
