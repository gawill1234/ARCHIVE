...
simple_search -H $SHOST -C $VCOLLECTION -Q "Plaintiff" -T $TNAME -n 1000
xx=$?
if [ $xx -ne 0 ]; then
...
simple_search -H $SHOST -C $VCOLLECTION -Q "2001" -T $TNAME -n 1000
xx=$?
if [ $xx -ne 0 ]; then
...
simple_search -H $SHOST -C $VCOLLECTION -Q "1872" -T $TNAME -n 1000
xx=$?
if [ $xx -ne 0 ]; then
...
simple_search -H $SHOST -C $VCOLLECTION -Q "UNITED+STATES+COURT+OF+APPEALS" -T $TNAME -n 1000
xx=$?
if [ $xx -ne 0 ]; then
...
simple_search -H $SHOST -C $VCOLLECTION -Q "violation" -T $TNAME -n 1000
xx=$?
if [ $xx -ne 0 ]; then
...
simple_search -H $SHOST -C $VCOLLECTION -Q "appeal" -T $TNAME -n 1000
xx=$?
if [ $xx -ne 0 ]; then
