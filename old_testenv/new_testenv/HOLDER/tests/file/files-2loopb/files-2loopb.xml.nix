...
<vse-collection name="files-2loop" modified="1214489359">
  ...
  <vse-meta name="files-2loop" creator="gary_testing" create-time="1214489317" elt-id="1" max-elt-id="1"/>
</vse-collection>
