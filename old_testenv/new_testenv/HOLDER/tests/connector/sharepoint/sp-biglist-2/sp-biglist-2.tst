...
if __name__ == "__main__":
   ...
   if ( sitetype == '2010' ):
      cmd_params['site'] = site = 'http://testbed18-1.test.vivisimo.com:7835/7835_SubSite'
      cmd_params['user'] = user = 'administrator'
      cmd_params['pw'] = pw = 'Mustang5'
      cmd_params['domain'] = domain = 'sptest'
      collection_name = "sp-biglist-2-2010"
      lock = simpleLock.simpleLock("tb18-1.7835")
   elif ( sitetype == '2007' ):
      cmd_params['site'] = site = 'http://testbed19-2.test.vivisimo.com:6634/6634_SubSite'
      cmd_params['user'] = user = 'administrator'
      cmd_params['pw'] = pw = 'VolvoV70'
      cmd_params['domain'] = domain = 'sp07test'
      collection_name = "sp-biglist-2-2007"
      lock = simpleLock.simpleLock("tb19-2.6634")
   else:
      cmd_params['site'] = site = 'http://testbed19-2.test.vivisimo.com:6634/6634_SubSite'
      cmd_params['user'] = user = 'administrator'
      cmd_params['pw'] = pw = 'VolvoV70'
      cmd_params['domain'] = domain = 'sp07test'
      collection_name = "sp-biglist-2-oldconn"
      lock = simpleLock.simpleLock("tb19-2.6634")
   ...
   try:
      ...
      if ( collection_name == 'sp-biglist-2-oldconn' ):
      ...
      #
      if ( collection_name == 'sp-biglist-2-2010' ):
