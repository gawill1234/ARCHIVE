...
import doc_updater, getopt, time, shutil

class doSPDelete ( Thread ):
   ...
   def run(self):
      ...
      for item in self.mylist:
         ...
         doc_updater.deleteTree(**self.cmd_params)
         etime = time.time()
...
if __name__ == "__main__":
   ...
   if ( sitetype == '2010' ):
      ...
      collection_name = "sp-continuous-add-del-2010"
      ...
      collection_name = "sp-continuous-add-del-2007"
      #glob_results = [3132, 8]
      glob_results = [647, 8]
   ...
   try:
      ...
      undoit = doSPDelete(site, user, pw, domain, runlist)
