...
public class GoGetXML {
   ...
   //
   private Hashtable cmnGetAttrAndDataWithDups(String startAt,
      ...
      for (int s = 0; s < nodeLst.getLength(); s++) {
         ...
         if (fstNode.getNodeType() == Node.ELEMENT_NODE) {
            ...
            stuff.put(Integer.toString(s), myAl);
         }
      }
   ...
   //
   public Hashtable getAttrAndDataWithDups(String startAt, ArrayList<String> attrList) {

      return(cmnGetAttrAndDataWithDups(startAt, attrList));
   }
   ...
   public Hashtable getAttrAndData(String startAt, ArrayList<String> attrList,
      ...
      return(cmnGetAttrAndData(startAt, attrList, stuff));
   }


   //public Hashtable getAttrAndData(String startAt, ArrayList<String> attrList,
   //                                Hashtable<String,String> gleeb) {
   ...
   //   trnsfr = gleeb.keys();
   //   while (trnsfr.hasMoreElements()) {
   //      String QRY = (String)trnsfr.nextElement();
   //      String QRYATTR = gleeb.get(QRY);
   //      ArrayList<String> myAl = new ArrayList<String>();
   //      myAl.add(QRYATTR);
   //      myAl.add("");
   //      stuff.put(QRY, myAl);
   ...
   public Set getListOfAttrs(String startAt, String whichVal) {
      return(getGeneralAttrList(startAt, whichVal));
   }
