...
@XmlRootElement(name = "collection-broker-enqueue-response")
public class CollectionBrokerEnqueueResponse {

    @XmlElement(name = "crawler-service-enqueue-response", required = true)
