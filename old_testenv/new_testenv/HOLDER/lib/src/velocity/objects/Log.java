 ...
 *       &lt;group ref="{urn:/velocity/objects}log-nodes" maxOccurs="unbounded" minOccurs="0"/>
...
public class Log {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "warning", namespace = "urn:/velocity/objects", type = JAXBElement.class),
        @XmlElementRef(name = "error", namespace = "urn:/velocity/objects", type = JAXBElement.class),
        @XmlElementRef(name = "debug", namespace = "urn:/velocity/objects", type = JAXBElement.class),
        @XmlElementRef(name = "msg", namespace = "urn:/velocity/objects", type = JAXBElement.class)
    })
    protected List<JAXBElement<LogMessage>> logNodes;
    @XmlAttribute
    ...
    /**
     * Gets the value of the logNodes property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the logNodes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLogNodes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link JAXBElement }{@code <}{@link LogMessage }{@code >}
     * {@link JAXBElement }{@code <}{@link LogMessage }{@code >}
     * {@link JAXBElement }{@code <}{@link LogMessage }{@code >}
     * {@link JAXBElement }{@code <}{@link LogMessage }{@code >}
     * 
     * 
     */
    public List<JAXBElement<LogMessage>> getLogNodes() {
        if (logNodes == null) {
            logNodes = new ArrayList<JAXBElement<LogMessage>>();
        }
