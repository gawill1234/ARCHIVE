...
@XmlRootElement(name = "AnnotationExpressUserSetQuery")
public class AnnotationExpressUserSetQuery {
    ...
    @XmlElement(required = true)
    protected AnnotationExpressUserSetQuery.Content content;
    @XmlElement(required = true)
    protected AnnotationExpressUserSetQuery.Query query;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link AnnotationExpressUserSetQuery.Content }
     *     
     */
    public AnnotationExpressUserSetQuery.Content getContent() {
        return content;
    }
     ...
     *     
     */
    public void setContent(AnnotationExpressUserSetQuery.Content value) {
        this.content = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link AnnotationExpressUserSetQuery.Query }
     *     
     */
    public AnnotationExpressUserSetQuery.Query getQuery() {
        return query;
    }
     ...
     *     
     */
    public void setQuery(AnnotationExpressUserSetQuery.Query value) {
        this.query = value;
    }
