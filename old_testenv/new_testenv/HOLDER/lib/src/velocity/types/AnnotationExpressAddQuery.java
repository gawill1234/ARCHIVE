...
@XmlRootElement(name = "AnnotationExpressAddQuery")
public class AnnotationExpressAddQuery {
    ...
    @XmlElement(required = true)
    protected AnnotationExpressAddQuery.Content content;
    @XmlElement(required = true)
    protected AnnotationExpressAddQuery.Query query;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link AnnotationExpressAddQuery.Content }
     *     
     */
    public AnnotationExpressAddQuery.Content getContent() {
        return content;
    }
     ...
     *     
     */
    public void setContent(AnnotationExpressAddQuery.Content value) {
        this.content = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link AnnotationExpressAddQuery.Query }
     *     
     */
    public AnnotationExpressAddQuery.Query getQuery() {
        return query;
    }
     ...
     *     
     */
    public void setQuery(AnnotationExpressAddQuery.Query value) {
        this.query = value;
    }
