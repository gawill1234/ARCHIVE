...
/*****************************************************/
/*  Routine to log any failure data from the shmwhatever()
    routines.
*/
...
/*****************************************************/
/*  Routine whose proper status is to fail to create
    using shmget.  In other words, to fail is to pass.
*/
...
/*****************************************************/
/*  Routine to create shared memory segments with shmget().
*/
...
/*****************************************************/
/*  Routine which should not return the id of the
    segment specified.
*/
...
/*****************************************************/
/*  Get the id of the segment with key as an identifier.
*/
...
/*****************************************************/
/*  Try and detach segment.  Should not be able to do it.
*/
...
/*****************************************************/
/*  Try and attach a segment of shared memory.  Should
...
/*****************************************************/
/*  Attach a segment of shared memory.
*/
...
/*****************************************************/
/*  Try and destroy a segment of shared memory.  Should not
    be able to do it.
*/
...
/*****************************************************/
/*  Destroy a segment of shared memory.
*/
...
/*****************************************************/
/*  Test case:  Get one too many segments.
    How      :  Try and attach a segment of shared memory twice.
...
/*****************************************************/
/*   Test case:  Get one too many segments.
     How:        Create a new segment and then try and attach it.
                 Should not succeed.
*/
...
/*****************************************************/
/*  Test case:  Get one too many segments
    How      :  Detach and existing segment.  Then try and reattach
                it twice.  Should fail of course.
*/
